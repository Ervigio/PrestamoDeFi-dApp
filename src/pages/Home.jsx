      ...
      <section className="flex flex-col gap-16 items-center">
        <div className="grid gap-3 px-5 bg-white p-4 border shadow rounded-lg text-sm w-72 sm:min-w-[60vw]">
          <div>
            ...
            <p className="py-3 text-xs sm:text-sm ">
              No todo el mundo puede acceder a los servicios
              financieros. Sin embargo, todo lo que necesita para acceder a
              Ethereum y a los productos de préstamos, toma de préstamos y
              ahorros integrados en Ethereum es una conexión a Internet.
      ...
      <section className="flex flex-col gap-16 items-center">
        <div className="grid gap-3 px-5 bg-white p-4 border shadow rounded-lg text-sm w-72 sm:min-w-[60vw]">
          <div>
            ...
            <p className="py-3 text-xs sm:text-sm ">
            Cualquiera puede interactuar con la red Ethereum o 
            construir aplicaciones en ella. Esto le permite controlar 
            sus propios activos e identidad, en lugar de estar controlados 
            por unas cuantas megacorporaciones.
            </p>
          </div>
        </div>
      </section>
